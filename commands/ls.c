 ...
 * @return
 * @see strcmp, __ls_print_usage, exit
 */
void __ls_parse_arguments(int argc, char *argv[]) {
 ...
 * @see __ls_parse_arguments
 */
int our_ls(int argc, char *argv[]) {
    // Parse the arguments
    __ls_parse_arguments(argc, argv);
